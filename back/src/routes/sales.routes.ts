...
import { salesSchemaRequest, salesSchemaUpdateRequest } from "../schemas/salesSchema.schema";
...
salesRoutes.patch('/:id', ensureBodyValidMiddleware(salesSchemaUpdateRequest), ensureIdMiddleware, updateSaleController)

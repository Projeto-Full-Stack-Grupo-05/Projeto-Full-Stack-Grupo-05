...
export class InitialMigration1693018686626 implements MigrationInterface {
    name = 'InitialMigration1693018686626'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sales" ADD CONSTRAINT "FK_bb8dd887cbc91286d62f367ddc3" FOREIGN KEY ("gallery_id") REFERENCES "galleries"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sales" DROP CONSTRAINT "FK_bb8dd887cbc91286d62f367ddc3"`);

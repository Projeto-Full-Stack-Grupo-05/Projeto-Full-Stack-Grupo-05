...
export class InitialMigration1692039266570 implements MigrationInterface {
    name = 'InitialMigration1692039266570'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "cellphone" character varying(20) NOT NULL, "birthdate" character varying NOT NULL, "description" character varying NOT NULL, "profile" character varying NOT NULL DEFAULT 'buyer', "createdAt" date NOT NULL DEFAULT now(), "deletedAt" date, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
